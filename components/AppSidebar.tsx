...
export function AppSidebar() {
  ...
  const navItems = [
    { label: t("nav.image", "Image"), href: `/gallery?tab=images${folderParam}`, icon: ImageIcon, active: pathname === "/gallery" && tab === "images" },
    { label: t("nav.video", "Video"), href: `/gallery?tab=videos${folderParam}`, icon: VideoIcon, active: pathname === "/gallery" && tab === "videos" },
    { label: t("nav.workflow", "Workflow"), href: "/workflow", icon: Workflow, active: pathname === "/workflow" || (pathname.startsWith("/workflow/") && pathname !== "/workflow") },
    { label: t("nav.assets", "Assets"), href: "#", icon: Package, active: false, disabled: true },
    { label: t("nav.chat", "Chat"), href: "/chat", icon: MessageSquare, active: pathname === "/chat" },
    { label: t("nav.settings", "Settings"), href: "#", icon: Settings, active: false, onClick: (e: React.MouseEvent) => { e.preventDefault(); setSettingsOpen(true); } },
  ];
