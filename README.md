...
1. Launch HeliosGen.
2. Open **Settings → API Keys** and paste your **[kie.ai](https://kie.ai?ref=25abb3f2236cbff9780ab9c2f84479ec)** or **[Magnific](https://www.magnific.com/cn/api) API key**.
3. Select 简体中文 in Settings if you prefer Chinese.
4. Start generating.
...
| Storage | Local disk |
| AI Backend | kie.ai and Magnific |

---

## 🌏 Language

The app includes English and 简体中文. Choose the language from the Settings
window; the choice is saved locally for the next launch.
